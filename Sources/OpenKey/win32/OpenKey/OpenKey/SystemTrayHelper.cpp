...
#define POPUP_ABOUT_vietypekey 1010
#define POPUP_vietypekey_EXIT 2000
...
map<UINT, LPCTSTR> menuData = {
	...
	{POPUP_ABOUT_vietypekey, _T("Giới thiệu vietypekey")},
	{POPUP_vietypekey_EXIT, _T("Thoát")},
};
	...
	case WM_TRAYMESSAGE: {
		...
		if (lParam == WM_LBUTTONUP) {
			...
			case POPUP_CONTROL_PANEL:
				AppDelegate::getInstance()->onControlPanel();
				break;
			case POPUP_ABOUT_vietypekey:
				AppDelegate::getInstance()->onvietypekeyAbout();
				break;
			case POPUP_vietypekey_EXIT:
...
void SystemTrayHelper::createPopupMenu() {
	...
	AppendMenu(popupMenu, MF_UNCHECKED, POPUP_ABOUT_vietypekey, menuData[POPUP_ABOUT_vietypekey]);
	AppendMenu(popupMenu, MF_SEPARATOR, 0, 0);
	AppendMenu(popupMenu, MF_UNCHECKED, POPUP_vietypekey_EXIT, menuData[POPUP_vietypekey_EXIT]);
